...
export default function DemoTest() {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-3 sm:p-5 md:p-6">
      <div className="w-full max-w-md md:max-w-xl bg-zinc-900 rounded-2xl p-4 sm:p-6 border border-zinc-700">
        {/* Title */}
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-5 sm:mb-6">
          Live Crypto Prices
        </h1>
        ...
        <div className="space-y-3 sm:space-y-4">
          {coins.map((coin) => (
            <div
              key={coin.symbol}
              className="bg-zinc-800 border border-zinc-700 rounded-xl p-4 sm:p-5 flex items-center justify-between"
            >
              {/* Left */}
              <div>
                <p className="text-zinc-400 text-xs sm:text-sm">Currency</p>
              ...
              {/* Right */}
              <div className="text-right">
                <p className="text-zinc-400 text-xs sm:text-sm">Live Price</p>
